...
export default function AdminDashboard() {
  ...
  const getStatus = (status) => {
    return (
      statusOptions.find((item) => item.value === status)?.label || "Unknown"
    );
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white border-l-4 border-gray-400 p-4">
            ...
            <p className="font-heading text-3xl font-bold">
              {orders.filter((o) => o.current_status === "confirmed").length}
            </p>
          </div>
          <div className="bg-white border-l-4 border-yellow-400 p-4">
            ...
            <p className="font-heading text-3xl font-bold">
              {orders.filter((o) => o.current_status === "shipped").length}
            </p>
          </div>
